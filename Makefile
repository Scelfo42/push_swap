...
SRCS_FILES = ft_push_swap.c ft_populate.c ft_check_errors.c ft_low_stack.c ft_moves.c ft_check_args.c ft_sort.c ft_free_all.c list_printer.c ft_double_moves.c ft_find_specific.c \
